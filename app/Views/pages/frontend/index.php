<div class = "row pt-4 pb-4">
    ...
    <div class = "col-sm-12 col-md-6 pb-4">
        <form method="post" action="" class="trend_sansone">
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="2" class="selectpicker w-100 form-control" id="flavour" name="flavours[]" onChange="getImage('flavour', '1');" required>
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="2" class="selectpicker w-100 form-control" id="inclusion" name="inclusions[]" onChange="getImage('inclusion', '2');" required>
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="1" class="selectpicker w-100 form-control" id="wafer" name="wafers[]" onChange="getImage('wafer', '4');" required>
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="2" class="selectpicker w-100 form-control" id="sprinkles" name="sprinkles[]" onChange="getImage('sprinkles', '3');" required>
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="2" class="selectpicker w-100 form-control" id="sauce" name="sauces[]" onChange="getImage('sauce', '5');" required>
