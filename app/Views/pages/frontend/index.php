<div class = "row pt-4 pb-4">
    ...
    <div class = "col-sm-6 pb-4">
        <form method="post" action="" class="trend_sansone">
            ...
            <select multiple data-style="bg-white rounded-pill px-4 py-3 shadow-sm" data-max-options="2" class="selectpicker w-100 form-control" id="flavour" name="flavours[]">
